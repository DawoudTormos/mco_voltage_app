...
char   HOST_NAME[] = "192.168.0.222";
char   HOST_NAME2[] = "http://192.168.0.222";
byte server[] = {192, 168, 1, 222};
String PATH_NAME   = "/";
...
if( (millis() - last_server_req ) > 2000  ){
last_server_req=millis();


  
  PATH_NAME = "/addChangeVoltage?voltage=" +  String(calculateVoltage(), 3);
 // Serial.print(server);
